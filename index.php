...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll-trigger" href="#page-top">Pandemic Workmate</a>
        ...
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
           ...
           <li class="nav-item active">
            <a class="nav-link js-scroll-trigger" href="login.php">C-19test</a>
          </li>

            <li class="nav-item active">
            <a class="nav-link js-scroll-trigger" href="bloodbank/login.php">Blood</a>
          </li>

           <li class="nav-item active">
            <a class="nav-link js-scroll-trigger" href="HotelMS-PHP/login.php">Rooms</a>
          </li>

          <li class="nav-item active">
            <a class="nav-link js-scroll-trigger" href="Blood_bank/admin.php">Platelets</a>
          </li>
...
Reported illnesses have ranged from mild symptoms to severe illness and death</p>
  ...
  <footer class="py-5 bg-dark">
    <div class="container">
      <p class="m-0 text-center text-white">Copyright &copy; Pandemic Workmate</p>
    </div>
    <!-- /.container -->
  </footer>
